...
$students = $db->query("SELECT * FROM users WHERE " . $clause . " AND role = 'STUDENT'");
$teachers = $db->query("SELECT * FROM users WHERE " . $clause . " AND role = 'TEACHER'");
?>
...
<body>
        ...
        <div class="flex content-container full-height">
            ...
            <div class="content full-width white">
                ...
                <div class="mx-20 t-end">
                    <?php
                    $url = (isset($_GET["type"]) && $_GET["type"] == "archived") ? "people.php" : "people.php?type=archived";
                        ...
                        <?php foreach ($students as $student) : ?>
                            <tr class="space-between">
                                ...
                                $btn = (isset($_GET["type"]) && $_GET["type"] == "archived") ? "restore-blue" : "x-blue";?>
                                    <img src="../images/<?= $btn ?>.png" class="<?= $class ?> pointer" alt="logo" id="<?= $student['id'] ?>" style="width: 20px;">
                                </td>
                            </tr>
                        <?php endforeach ?>
                    <?php else : ?>
                    ...
                    <?php if ($teachers->num_rows > 0) : ?>
                        <?php foreach ($teachers as $teacher) : ?>
                            <tr class="space-between">
                                ...
                                <td>
                                <?php $class = (isset($_GET["type"]) && $_GET["type"] == "archived") ? "res-btn" : "del-btn";
                                $btn = (isset($_GET["type"]) && $_GET["type"] == "archived") ? "restore" : "x-blue";?>
                                    <img src="../images/<?= $btn ?>.png" class="<?= $class ?> pointer" alt="logo" id="<?= $teacher['id'] ?>" style="width: 20px;">
                                </td>
                            </tr>
                        <?php endforeach ?>
                    <?php else : ?>
    ...
    <div id="modal-restore" class="modal-bg">
        <div class="modal-body">
            ...
            <div class="centered-align flex-col">
                ...
                <form action="../../backend/teacher/restore_user.php" method="POST">
                    <input type="hidden" name="id" id="del-val" value="">
    ...
    <script>
        ...
        $(document).on("click", ".res-btn", (e) => {
            ...
            $("#name").text(name);
            $("#del-val").val(id);
            $("#restore").attr("href", "../../backend/admin/restore_user.php?id="+ $(e.currentTarget).attr("id"));
        });
