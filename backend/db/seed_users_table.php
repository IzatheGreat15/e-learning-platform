...
$sql = "INSERT users (fname,lname,role,address,contact_num,email,password, token) VALUES
                    ('sample', 'admin', 'ADMIN', 'home', '09954119907', 'sample_admin@gmail.com', '".password_hash('password', PASSWORD_DEFAULT)."', '".password_hash('passwordsample_admin@gmail.com', PASSWORD_DEFAULT)."'),
                    ('sample', 'student', 'STUDENT', 'home', '09954119907', 'sample_student@gmail.com', '".password_hash('password', PASSWORD_DEFAULT)."', '".password_hash('passwordsample_student@gmail.com', PASSWORD_DEFAULT)."'),
                    ('sample', 'teacher', 'TEACHER', 'home', '09954119907', 'sample_teacher@gmail.com', '".password_hash('password', PASSWORD_DEFAULT)."', '".password_hash('passwordsample_teacher@gmail.com', PASSWORD_DEFAULT)."'),
                    ('sample', 'registrar', 'REGISTRAR', 'home', '09954119907', 'sample_registrar@gmail.com', '".password_hash('password', PASSWORD_DEFAULT)."', '".password_hash('passwordsample_registrar@gmail.com', PASSWORD_DEFAULT)."')";
